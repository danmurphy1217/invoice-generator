...
type ApiResponse struct {
	...
	StatusCode int32  `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"` // Status code of the response
...
type GenerateInvoiceHandlerRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TruckId string `protobuf:"bytes,1,opt,name=truckId,proto3" json:"truckId,omitempty"`
}

func (x *GenerateInvoiceHandlerRequest) Reset() {
	*x = GenerateInvoiceHandlerRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GenerateInvoiceHandlerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GenerateInvoiceHandlerRequest) ProtoMessage() {}

func (x *GenerateInvoiceHandlerRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_models_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GenerateInvoiceHandlerRequest.ProtoReflect.Descriptor instead.
func (*GenerateInvoiceHandlerRequest) Descriptor() ([]byte, []int) {
	return file_api_models_proto_rawDescGZIP(), []int{3}
}

func (x *GenerateInvoiceHandlerRequest) GetTruckId() string {
	if x != nil {
		return x.TruckId
	}
	return ""
...
var file_api_models_proto_rawDesc = []byte{
	0x0a, 0x10, 0x61, 0x70, 0x69, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x0a, 0x61, 0x70, 0x69, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x22, 0x14,
	...
	0x61, 0x6c, 0x74, 0x68, 0x79, 0x22, 0x48, 0x0a, 0x0b, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73, 0x70,
	...
	0x39, 0x0a, 0x1d, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x76, 0x6f, 0x69,
	0x63, 0x65, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x18, 0x0a, 0x07, 0x74, 0x72, 0x75, 0x63, 0x6b, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x74, 0x72, 0x75, 0x63, 0x6b, 0x49, 0x64, 0x32, 0x64, 0x0a, 0x12, 0x48, 0x65,
	...
	0x1e, 0x2e, 0x61, 0x70, 0x69, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2e, 0x48, 0x65, 0x61,
	0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x1f, 0x2e, 0x61, 0x70, 0x69, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2e, 0x48, 0x65, 0x61,
	0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x42, 0x0d, 0x5a, 0x0b, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x67, 0x65, 0x6e, 0x62,
...
var file_api_models_proto_goTypes = []any{
	(*HealthCheckRequest)(nil),            // 0: api_models.HealthCheckRequest
	(*HealthCheckResponse)(nil),           // 1: api_models.HealthCheckResponse
	(*ApiResponse)(nil),                   // 2: api_models.ApiResponse
	(*GenerateInvoiceHandlerRequest)(nil), // 3: api_models.GenerateInvoiceHandlerRequest
}
var file_api_models_proto_depIdxs = []int32{
	0, // 0: api_models.HealthCheckService.HealthCheck:input_type -> api_models.HealthCheckRequest
	1, // 1: api_models.HealthCheckService.HealthCheck:output_type -> api_models.HealthCheckResponse
...
func file_api_models_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_models_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_models_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_api_models_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_api_models_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*GenerateInvoiceHandlerRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
