...
const (
	HealthCheckService_HealthCheck_FullMethodName = "/api_models.HealthCheckService/HealthCheck"
)
...
var HealthCheckService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api_models.HealthCheckService",
